...
<div class="content home">
	<h2>Votaciones</h2>
	<p>Esta página se usará para votaciones de los empleados</p>
    <p>AVISO: Crear votaciones solo cuando sea necesario</p>
	<a href="create.php" class="create-poll">Crear Votacion</a>
	<table>
        <thead>
            <tr>
                <td>#</td>
